...
public:
     ...
     * this method has to be called prior to any gettter to have up to date
     * data.
     */
    void acquire_sensors();

    /**
     * @brief zero_joint_positions Use the current motor position to set the
     * zero position for the joint angles.
     */
    void zero_joint_positions();

    /**
     * @brief disable_can_recv_timeout Disable the disable_can_recv_timeout for
     * all can boards.
     */
     ...
     * @return the max current that has been hard-coded in the constructor of
     ...
     * @return the max torque that has been hard-coded in the constructor of
     * this class. TODO: parametrize this via YAML or something else.
     */
